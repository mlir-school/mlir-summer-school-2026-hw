//===- Exercise_2_4_ListSimplify.cpp ----------------------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
// Exercise 2: list.from_elements pattern
//===----------------------------------------------------------------------===//
...
/// which the canonicalizer of `list.from_elements` replaces with `list.empty`.
...
struct ListSimplifyPass : public impl::ListSimplifyBase<ListSimplifyPass> {
  ...
  void runOnOperation() override {
    ...
    patterns.add<PeelFromElements, LowerMapToWhileLoop>(patterns.getContext());
